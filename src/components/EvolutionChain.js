...
// a single evolution chain (e.g. bulbasaur -> ivyasaur -> venusaur)
function EvolutionChain(props) {
  return (
    <div className="evo-chain d-flex flex-column flex-sm-row">
      ...
      {props.firstEvoTrigger !== undefined &&
      props.firstEvolution != undefined ? (
        <div className="col-sm-4">
          {createFirstEvolution(props.firstEvoTrigger, props.firstEvolution)}
        </div>
      ) : null}
      {props.secondEvoTrigger !== undefined &&
      props.secondEvolution != undefined ? (
        <div className="col-sm-4">
...
const createFirstForm = (firstForm) => <Pokemon name={firstForm} />;
